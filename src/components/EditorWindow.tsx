      ...
      {settings?.show_status_bar !== false && (
        <div className="status-bar">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => useEditorStore.getState().setActivePanel('clipboard')}
              className="text-xs px-2 py-1 rounded bg-[var(--editor-surface)] border border-[var(--editor-border)] hover:border-[var(--editor-accent)] transition-colors flex items-center gap-1"
